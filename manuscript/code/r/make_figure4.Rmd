...
ggsave("../../manuscript/figure_output/figure4/first_target_plot.png", target_line_plot1, height=3, width=3, limitsize=FALSE, units="in")
```
...
ggsave("../../manuscript/figure_output/figure4/second_target_plot.png", target_line_plot2, height=3, width=3, limitsize=FALSE, units="in")
```
