...
target_data1 <- read.table("paper_data5.tsv", header=TRUE)
...
ggsave("../../data/figures/figure4/first_target_plot.png", target_line_plot1, height=3, width=3, limitsize=FALSE, units="in")
```
...
#Read in file to create target pattern graph
target_data2 <- read.table("paper_data19.tsv", header=TRUE)
...
ggsave("../../data/figures/figure4/second_target_plot.png", target_line_plot2, height=3, width=3, limitsize=FALSE, units="in")
```
...
ggsave("../../data/figure_output/figure4/entropy_bar_plot.png", entropy_bar_plot, height=4, width=8, limitsize=FALSE, units="in")
