...
df <- df %>% filter(pattern != c("13", "14", "15", "16", "17", "18"))
for(data in c(1:12, 19:66)){
...
df$pattern <- factor(df$pattern,levels = c(5,30,32,39,19,7,45,56,52,64))
...
for(dat in c(1,25,31,37,19,7,43,55,49,61)){
...
ggsave("../../data/figure_output/figure3/figure3.png", figure3, height=8, width=12, limitsize=FALSE, units="in")
