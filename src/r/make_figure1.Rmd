...
figure1 <- grid.arrange(img1, rasterGrob(img2, vjust=3.5, width=0.98), rasterGrob(img3, vjust=3.71, width=0.98), rasterGrob(img4, vjust=3.74, width=0.99), target_line_plot, line_plot_zero, line_plot_int, line_plot_final, sos_line_plot, layout_matrix=rbind(c(1,2,3,4), c(5,6,7,8), c(9,9,9,9)), widths=c(2.3,2,2,2))
