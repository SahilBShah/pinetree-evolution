...
setwd("../../results/2020_5_6/positive_control_nf1.0_rep0_nmut5/")
...
#Set working directory to the directory in which the first output data is contained in 
setwd("../../results/2020_5_6/positive_control_nf1.0_rep0_nmut5/final/")
...
img1 <- arrangeGrob(rasterGrob(img1, vjust=3.18, width=0.95, hjust=0.45), top=textGrob("A", x = unit(0, "npc"), y=unit(-8.5, "npc"), just=c("left","top"), gp=gpar(col="black", font="bold", fontsize=60, fontfamily="Arial")))
...
figure1 <- grid.arrange(img1, rasterGrob(img2, vjust=3.5, width=0.98), rasterGrob(img3, vjust=3.71, width=0.98), rasterGrob(img4, vjust=3.74, width=0.99), target_line_plot, line_plot_zero, line_plot_int, line_plot_final, sse_line_plot, layout_matrix=rbind(c(1,2,3,4), c(5,6,7,8), c(9,9,9,9)), widths=c(2.3,2,2,2))
