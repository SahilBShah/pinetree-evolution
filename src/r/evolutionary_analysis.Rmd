...
target_data <- read.table("paper_data6.tsv", header=TRUE)
target_data <- filter(target_data, species == "protein1" | species == "protein2" | species == "protein3")
#target_data <- filter(target_data, species == "protein1" | species == "protein2" | species == "protein3" | species == "protein4" | species == "protein5" | species == "protein6" | species == "protein7" | species == "protein8" | species == "protein9" | species == "protein10")
target_line_plot <-  ggplot(target_data, aes(fill=species, color=species, size=species, x=time, y=transcript)) + 
  ...
  ggsave("../figures/paper_data6.png", target_line_plot, width=10, height=10, limitsize=FALSE)
...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_8_23/paper_data48_rep2_nmut10/")
...
line_plot <-  ggplot(plot_data, aes(fill=species, color=species, size=species, x=time, y=transcript)) + 
  ...
  ylab('Transcript abundance') +
  xlab("Time (s)")
ggsave("../../../data/figures/paper_data48_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
