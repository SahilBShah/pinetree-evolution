...
setwd("../../results/2020_4_3/grant_data4_nf0.5_rep1_nmut3/")
...
ggsave("../../../data/figures/sos_graphs_grant_data4_nf05.pdf", sos_plots, width=20, height=10)
```
...
target_data <- read.table("../../../data/grant_data4.tsv", header=TRUE)
...
ggsave("../../../data/figures/grant_data4_nf05.pdf", evo_plot, width=30, height=30, limitsize=FALSE)
