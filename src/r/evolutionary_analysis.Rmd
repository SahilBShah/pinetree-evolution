...
setwd("../../data/targets/")
#setwd("../../results/paper_data145/rep14/final/")
#setwd("/home/sahil/")

#Change grant_data name to the target file used
#target_data <- read.table("expression_pattern_best.tsv", header=TRUE)
#target_data <- read.table("test.tsv", header=TRUE)
target_data <- read.table("paper_data61.tsv", header=TRUE)
...
ggsave("../../data/figure_output/paper_data61_black.png", target_line_plot, width=4, height=4, limitsize=FALSE, units = "in")
...
ggsave("../../../data/figure_output/rmse_graphs_paper_data13_rep8_nf1.png", rmse_plots, width=20, height=10)
```
...
#library(cowplot)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/paper_data66/rep14/")
...
plot_data <- filter(plot_data, (species == "protein1" | species == "protein2" | species == "protein3" | species == "protein4" | species == "protein5" | species == "protein6" | species == "protein7" | species == "protein8" | species == "protein9" | species == "protein10") & time != "301")
...
ggsave("../../../data/figure_output/supp/paper_data66_lowest.png", line_plot, width=4, height=4, limitsize=FALSE, units="in")
# #Change grant_data name to the target file used
...
# ggsave("../../../data/figure_output/paper_data139_rep0_nf1000.png", evo_plot, width=30, height=30, limitsize=FALSE)
# # 
...
# ggsave("../../../data/figure_output/paper_data1_rep6_rmse.png", rmse_line_plot, width=20, height=10, limitsize=FALSE)

```

```{r}
setwd("../../results/2020_8_18/paper_data30_rep8_nmut10/")
rmse_data <- read.table("./final/rmse_data.tsv", header=TRUE)
rmse_data <- rmse_data %>% filter(Accepted=='yes')
min_rmse <- rmse_data$Iteration[rmse_data$NRMSE == min(rmse_data$NRMSE)]
```
...
library(cowplot)
#Set working directory to the directory in which the results are contained in 
setwd("../../tests/single_run_outputs/")


plot_data <- read.table("./expression_pattern.tsv", header=TRUE)
plot_data <- filter(plot_data, (species == "protein1" | species == "protein2" | species == "protein3" | species == "protein4" | species == "protein5" | species == "protein6" | species == "protein7" | species == "protein8" | species == "protein9" | species == "protein10") & time != "301")
line_plot <-  ggplot(plot_data, aes(fill=species, color=species, size=species, x=time, y=transcript)) + 
...
ggsave("./exp_pattern.png", line_plot, width=5, height=5, limitsize=FALSE, units="in")
