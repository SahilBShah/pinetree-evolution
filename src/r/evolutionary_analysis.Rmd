...
target_data <- read.table("paper_data17.tsv", header=TRUE)
...
ggsave("figures/paper_data17.png", target_line_plot, width=10, height=10, limitsize=FALSE)
...
sse_line_plot <- ggplot(sse_data_acc, aes(x=Iteration, y=SSE)) + 
  ...
  xlab("Generation") + 
  ylab("Root mean squared error (log scale)") + 
  panel_border() +
  scale_x_log10()
