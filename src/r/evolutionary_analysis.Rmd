...
target_data <- read.table("test1.tsv", header=TRUE)
#target_data <- read.table("p   aper_data13.tsv", header=TRUE)
...
#ggsave("figures/paper_data13.png", target_line_plot, width=10, height=10, limitsize=FALSE)
ggsave("test1.png", target_line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/sse_graphs_paper_data13_rep8_nf1.png", sse_plots, width=20, height=10)
```
...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_5_29/positive_control_nf1.0_rep1_nmut5/")
...
plots_list <- list()
#Change grant_data name to the target file used
target_data <- read.table("../../../data/positive_control2.tsv", header=TRUE)
target_data <- filter(target_data, species == "protein1" | species == "protein2" | species == "protein3")
...
ggsave("../../../data/figures/positive_control2_rep8_nf1.png", evo_plot, width=30, height=30, limitsize=FALSE)
...
ggsave("../../../data/figures/positive_control2_rep8_nf1_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/positive_control2_rep8_nf1_sse.png", sse_line_plot, width=20, height=10, limitsize=FALSE)

```

```{r}
setwd("../../results/2020_5_29/positive_control_nf1.0_rep2_nmut5/")
sse_data <- read.table("./final/sse_data.tsv", header=TRUE)
sse_data <- sse_data %>% filter(Accepted=='yes')
min_sse <- sse_data$Iteration[sse_data$SSE == min(sse_data$SSE)]
```
