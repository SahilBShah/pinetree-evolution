...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_5_29/paper_data13_nf1.0_rep1_nmut5/")
...
plots_list <- list()
#Change grant_data name to the target file used
target_data <- read.table("../../../data/paper_data13.tsv", header=TRUE)
target_data <- filter(target_data, species == "protein1" | species == "protein2" | species == "protein3")
...
ggsave("../../../data/figures/paper_data13_rep1_nf1.png", evo_plot, width=30, height=30, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data13_rep1_nf1_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data13_rep1_nf1_sse.png", sse_line_plot, width=20, height=10, limitsize=FALSE)
