...
plots_list <- list()
    target_data <- read.table("/home/sahil/pinetree-toys/data/three_genes_replicated_1232.tsv", header=TRUE)
...
ggsave("/home/sahil/pinetree-toys/data/figures/three_genes_replicated_1232.pdf", evo_plot, width=30, height=30, limitsize=FALSE)
