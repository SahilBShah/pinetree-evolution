...
target_data <- read.table("paper_data139.tsv", header=TRUE)
...
ggsave("../figures/paper_data139.png", target_line_plot, width=10, height=10, limitsize=FALSE)
...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_7_23/paper_data139_rep0_nmut10/")
...
plots_list <- list()
#Change grant_data name to the target file used
target_data <- read.table("../../../data/targets/paper_data139.tsv", header=TRUE)
target_data <- filter(target_data, species == "protein1" | species == "protein2" | species == "protein3")
...
ggsave("../../../data/figures/paper_data139_rep0_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data139_rep0_rmse.png", rmse_line_plot, width=20, height=10, limitsize=FALSE)
