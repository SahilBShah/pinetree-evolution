...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_6_14/paper_data1_nf1.0_rep0_nmut20/")
...
ggsave("../../../data/figures/paper_data1_rep0_nf1.png", evo_plot, width=30, height=30, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data1_rep0_nf1_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data1_rep0_nf1_sse.png", sse_line_plot, width=20, height=10, limitsize=FALSE)
