...
setwd("/home/sahil/tacc_results/random_data5_nf10_rep10_nmut20/")

plots_list <- list()

best_files <- list.files("/home/sahil/tacc_results/random_data5_nf10_rep10_nmut20/", pattern="three_genes_replicated_")
best_files <- mixedsort(sort(best_files))
plots_list <- list()
target_data <- read.table("/home/sahil/pinetree-toys/data/random_data5.tsv", header=TRUE)
...
evo_plot <- grid.arrange(target_line_plot, best_plot1, best_plot2, nrow=1, ncol=3, top="Evolutionary Pattern of Gene Transcripts")
ggsave("/home/sahil/tacc_results/random_data5_nf10_rep10_nmut20/evolution_graphs.pdf", evo_plot, width=30, height=30, limitsize=FALSE)
