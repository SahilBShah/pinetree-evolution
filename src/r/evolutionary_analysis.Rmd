...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_7_24/paper_data1_rep10_nmut10/")
...
ggsave("../../../data/figures/paper_data1_rep10_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data1_rep10_rmse.png", rmse_line_plot, width=20, height=10, limitsize=FALSE)
