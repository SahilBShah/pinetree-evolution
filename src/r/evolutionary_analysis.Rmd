...
target_data <- read.table("rnase_bet.tsv", header=TRUE)
...
ggsave("rnase_bet.png", target_line_plot, width=10, height=10, limitsize=FALSE)
...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_5_20/paper_data13_nf1.0_rep2_nmut5/")
...
ggsave("../../../data/figures/paper_data13_rep2_nf1.png", evo_plot, width=30, height=30, limitsize=FALSE)
...
ggsave("../../../data/figures/paper_data13_rep2_nf1_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)


#Set working directory to the directory in which the results are contained in
setwd("../../../results/2020_5_12/paper_data10_nf1.0_rep1_nmut5/")
...
ggsave("../../../data/figures/paper_data10_rep1_nf1_sos.png", sos_line_plot, width=20, height=10, limitsize=FALSE)
