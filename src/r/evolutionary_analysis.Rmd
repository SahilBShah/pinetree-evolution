...
library(gtools)
#Set working directory to the directory in which the results are contained in 
setwd("../../results/2020_7_1/positive_control3_rep0_nmut20/")
...
plots_list <- list()
#Change grant_data name to the target file used
# target_data <- read.table("../../../data/paper_data1.tsv", header=TRUE)
# target_data <- filter(target_data, species == "protein1" | species == "protein2" | species == "protein3")
...
# ggsave("../../../data/figures/paper_data1_rep103_nf1000.png", evo_plot, width=30, height=30, limitsize=FALSE)
# 
...
ggsave("../../../data/figures/positive_control3_rep0_lowest.png", line_plot, width=10, height=10, limitsize=FALSE)
...
ggsave("../../../data/figures/positive_control3_rep0_sse.png", sse_line_plot, width=20, height=10, limitsize=FALSE)
