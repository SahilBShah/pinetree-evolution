...
ggsave("../../data/figures/paper_data61_black.png", target_line_plot, width=4, height=4, limitsize=FALSE, units = "in")
...
ggsave("../../../data/figures/supp/paper_data66_lowest.png", line_plot, width=4, height=4, limitsize=FALSE, units="in")
# #Change grant_data name to the target file used
