...
def main():
    ...
    with open('../../../results/2020_8_24/positive_control3_rep3_nmut10/gene_0.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    output_dir = '../../../data/figures/figure1/figure1_gen0_genome_arch.png'
    create_genome_architecture(gene_file, output_dir)
    #Intermediate generation genome architecture
    with open('../../../results/2020_8_24/positive_control3_rep3_nmut10/gene_488.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    output_dir = '../../../data/figures/figure1/figure1_intermed_genome_arch.png'
    create_genome_architecture(gene_file, output_dir)
    #Final genome architecture
    with open('../../../results/2020_8_24/positive_control3_rep3_nmut10/final/gene_best.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    ...
    with open('../../../results/2020_8_13/paper_data1_rep1_nmut10/final/gene_best.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    output_dir = '../../../data/figures/figure2/figure2_final1_genome_arch.png'
    create_genome_architecture(gene_file, output_dir)
    #Final second genome architecture
    with open('../../../results/2020_8_14/paper_data5_rep7_nmut10/final/gene_best.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    output_dir = '../../../data/figures/figure2/figure2_final2_genome_arch.png'
    create_genome_architecture(gene_file, output_dir)
    #Final third genome architecture
    with open('../../../results/2020_8_17/paper_data19_rep18_nmut10/final/gene_best.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    output_dir = '../../../data/figures/figure2/figure2_final3_genome_arch.png'
    create_genome_architecture(gene_file, output_dir)
    #Final fourth genome architecture
    with open('../../../results/2020_8_14/paper_data7_rep10_nmut10/final/gene_best.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
    output_dir = '../../../data/figures/figure2/figure2_final4_genome_arch.png'
    create_genome_architecture(gene_file, output_dir)
    #Final fifth genome architecture
    with open('../../../results/2020_8_25/paper_data64_rep7_nmut10/final/gene_best.yml', 'r') as gene_parameters:
        gene_file = yaml.safe_load(gene_parameters)
