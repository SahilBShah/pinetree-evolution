...
for i in range(1, 151):
    transcript_list.append([i, "protein1", (0.10 * i)])
    transcript_list.append([i, "protein2", (0.15 * i)])
    transcript_list.append([i, "protein3", (0.05 * i)])
    if i == 150:
        protein1_list.append(0.10 * i)
        protein2_list.append(0.15 * i)
...
file = open("../../../data/paper_data14.tsv", "w")
